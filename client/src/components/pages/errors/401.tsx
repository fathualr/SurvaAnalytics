  ...
  return (
    <>
      ...
      <main className="flex flex-col items-center justify-center min-h-screen px-4 text-center bg-background">
        <h1 className="text-5xl font-bold text-destructive mb-2">Error - 401</h1>
        <p className="text-lg text-muted-foreground mb-6">Anda belum login. Silakan login terlebih dahulu untuk melanjutkan.</p>
        <div className="flex">
