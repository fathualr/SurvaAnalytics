...
export default function HomePage() {
  ...
  return (
    <main className="flex flex-col w-full overflow-hidden min-h-screen">
      ...
      <GridBackgroundDemo>
        <section className="pt-20 md:pt-24 pb-16 min-h-screen grid grid-cols-1 lg:grid-cols-2 items-center md:px-20 sm:px-10 px-5 from-primary-1 via-primary-2 to-primary-3 text-foreground">
          <div
            data-aos="fade-down"
            className="col-span-1 lg:row-start-1 row-start-2 flex flex-col md:gap-8 gap-4 lg:items-start items-center text-center lg:text-left"
          >
            ...
            <div className="flex xl:flex-row flex-col xl:justify-start justify-center items-center md:gap-5 gap-3 w-full">
              <Link
                href="/explore"
                className="inline-flex gap-1 items-center justify-center px-8 md:py-4 py-3 text-lg sm:text-xl md:text-2xl font-semibold
              ...
              <Link href="/generate-survey" passHref>
                <ShinyGeminiButton className="px-4 md:py-4 py-3">
          ...
          <div data-aos="fade-down" className="select-none col-span-1 row-start-1 flex items-center justify-center">
            <Image
              ...
              height={0}
              sizes="100vw"
              className="w-full h-auto lg:max-h-[600px] max-h-[300px] object-contain"
              priority
            />
          </div>
        </section>
      ...
      <section data-aos="fade-up" className="py-16 md:px-20 sm:px-10 px-5 grid grid-cols-1 md:grid-cols-2 md:gap-6 items-center text-foreground">
      ...
      <section className="flex flex-col py-20 md:px-20 sm:px-10 px-5 gap-16 text-foreground">
        <h2 data-aos="zoom-in" className="text-4xl md:text-5xl font-bold text-center">
          How Surva Works
        </h2>
      ...
      >
        <div data-aos="fade-right" className="col-span-1 flex flex-col justify-center gap-6">
          <h2 className="md:text-4xl text-3xl font-bold text-center md:text-left">
            We still need your opinion
          </h2>
          <p className="md:text-lg text-base text-muted-foreground text-justify">
            We’re always improving your experience on Surva. Share your opinion, suggestion, or feedback to help us grow better!
          </p>
        </div>

        <div data-aos="fade-left" className="col-span-1 flex justify-center">
          <div
      ...
      <section className="flex flex-col items-center py-20 md:px-20 sm:px-10 px-5 gap-10 text-foreground">
        <h2 data-aos="fade-up" className="text-center md:text-4xl text-3xl font-bold">
