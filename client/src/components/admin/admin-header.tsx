...
export function AdminHeader() {
  ...
  return (
    <header className="sticky top-0 w-full flex justify-between items-center gap-2 bg-primary-1 border border-y-0 border-r-0 border-l-accent-1/10 py-1 h-16 md:px-6 px-3">
      <SidebarTrigger />
