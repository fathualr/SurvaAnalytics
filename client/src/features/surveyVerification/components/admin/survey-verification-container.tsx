...
import { QuestionList } from '@/features/surveyQuestion/components/admin/question-list';
...
export const SurveyVerificationContainer = ({ surveyId }: Props) => {
  ...
  if (loading || !data || data.status !== 'under_review') {
    return (
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="pt-6 border-t">
        <h3 className="font-semibold text-lg">Pertanyaan Survei</h3>
      </div>
